...
/**
 * Home-screen widget that mirrors the balcony thermometer. It refreshes automatically
 * (see updatePeriodMillis in temp_widget_info.xml) and whenever the widget is tapped.
 */
